...
let theWheel = new Winwheel({
    ...
    'segments':        // Define segments including colour and text.
        [
            { fillStyle: '#eae56f', text: 'Lagu 1', id: Math.floor(Math.random() * Date.now()) },
            { fillStyle: '#89f26e', text: 'Lagu 2', id: Math.floor(Math.random() * Date.now()) },
            { fillStyle: '#c100be', text: 'Lagu 3', id: Math.floor(Math.random() * Date.now()) },
